...
- (void)initData {
    self.data = [[NameDict getAllHouseType].allKeys sortedArrayWithOptions:NSSortConcurrent usingComparator:^NSComparisonResult(NSString*  _Nonnull obj1, NSString*  _Nonnull obj2) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    [DataManager shared].requirementPageSelectedHouseType = self.data[indexPath.row];
