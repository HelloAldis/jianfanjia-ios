...
+ (void)initialize {
    if ([self class] == [NotificationDetailViewController class]) {
        NotificationTitles = @{
                               ...
                               kDesignerPNFromSystemMsg:@"公告",
                               kDesignerPNFromBasicInfoAuthPass:@"公告",
                               kDesignerPNFromBasicInfoAuthNotPass:@"公告",
                               kDesignerPNFromIDAuthPass:@"公告",
                               kDesignerPNFromIDAuthNotPass:@"公告",
                               kDesignerPNFromWorksiteAuthPass:@"公告",
                               kDesignerPNFromWorksiteAuthNotPass:@"公告",
                               kDesignerPNFromProductAuthPass:@"公告",
                               kDesignerPNFromProductAuthNotPass:@"公告",
                               kDesignerPNFromProductBreakRule:@"公告",
