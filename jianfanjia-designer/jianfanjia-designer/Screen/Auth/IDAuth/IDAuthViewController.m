...
- (void)initUI {
    ...
    self.sectionArr1 = @[
                         ...
                         [EditCellItem createField:@"身份证号" value:self.designer.uid placeholder:@"请输入15位或18位身份证号码" itemEditBlock:^(EditCellItem *curItem, EditCellItemEditType itemEditType) {
                             @strongify(self);
                             if (itemEditType ==  EditCellItemEditTypeChange) {
