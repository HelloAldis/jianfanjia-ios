...
@property(nonatomic, strong) NSArray *work_types;
...
@property(nonatomic, strong) NSNumber *dec_fee_half;
@property(nonatomic, strong) NSNumber *dec_fee_all;
@property(nonatomic, strong) NSString *auth_type;
@property(nonatomic, strong) NSString *uid_auth_type;
@property(nonatomic, strong) NSString *communication_type;
