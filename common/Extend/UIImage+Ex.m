...
- (UIImage *)imageByRoundCornerRadius:(CGFloat)radius backgroundColor:(UIColor *)backgroundColor {
    return [self imageByRoundCornerRadius:radius corners:UIRectCornerAllCorners backgroundColor:backgroundColor opaque:YES borderWidth:0 borderColor:nil borderLineJoin:kCGLineJoinMiter];
}
...
- (UIImage *)imageByRoundCornerRadius:(CGFloat)radius
    ...
    return [self imageByRoundCornerRadius:radius corners:corners backgroundColor:[UIColor clearColor] opaque:NO borderWidth:borderWidth borderColor:borderColor borderLineJoin:borderLineJoin];
}
...
- (UIImage *)imageByRoundCornerRadius:(CGFloat)radius
    ...
    [backgroundColor set];
    UIRectFill(CGRectMake(rect.origin.x, rect.origin.y, rect.size.width, rect.size.height));
